            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseDoctor" class="collapse" aria-labelledby="headingTwo"
                        ...
                        <div class="bg-white py-2 collapse-inner rounded">
                            <a class="collapse-item"
                                href="<?php echo e(route('doctor.create')); ?>"><?php echo e(__('sentence.New Doctor')); ?></a>
                            <a class="collapse-item"
                                href="<?php echo e(route('doctor.all')); ?>"><?php echo e(__('sentence.All Doctors')); ?></a>
                        </div>
                    </div>
                </li>
                <!-- Divider -->
                    ...
                    <div id="collapseNurse" class="collapse" aria-labelledby="headingTwo"
                        ...
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <div id="collapseNurseBookings" class="collapse" aria-labelledby="headingTwo"
                                ...
                                <div class="bg-white py-2 collapse-inner rounded">
                                    <a class="collapse-item"
                                        href="<?php echo e(route('nursebooking.create')); ?>"><?php echo e(__('sentence.New Nurse Booking')); ?></a>
                                    <a class="collapse-item"
                                        href="<?php echo e(route('nursebooking.all')); ?>"><?php echo e(__('sentence.All Nurse Bookings')); ?></a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseSpeciality" class="collapse" aria-labelledby="headingTwo"
                        ...
                        <div class="bg-white py-2 collapse-inner rounded">
                            <a class="collapse-item"
                                href="<?php echo e(route('speciality.create')); ?>"><?php echo e(__('sentence.New Speciality')); ?></a>
                            <a class="collapse-item"
                                href="<?php echo e(route('speciality.all')); ?>"><?php echo e(__('sentence.All Speciality')); ?></a>
                        </div>
                    </div>
                </li>
                <!-- Divider -->
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseRating" class="collapse" aria-labelledby="headingTwo"
                        ...
                        <div class="bg-white py-2 collapse-inner rounded">
                            <a class="collapse-item"
                                href="<?php echo e(route('rating.all')); ?>"><?php echo e(__('sentence.All Ratings')); ?></a>
                        </div>
                    </div>
                </li>
                <!-- Divider -->
                ...
                <li class="nav-item">
                    ...
                    <div id="collapsePackage" class="collapse" aria-labelledby="headingTwo"
                        ...
                        <div class="bg-white py-2 collapse-inner rounded">
                            <a class="collapse-item"
                                href="<?php echo e(route('package.create')); ?>"><?php echo e(__('sentence.New Package')); ?></a>
                            <a class="collapse-item"
                                href="<?php echo e(route('package.all')); ?>"><?php echo e(__('sentence.All Packages')); ?></a>
                        </div>
                    </div>
                </li>
                <!-- Divider -->
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseCoupon" class="collapse" aria-labelledby="headingTwo"
                        ...
                        <div class="bg-white py-2 collapse-inner rounded">
                            <a class="collapse-item"
                                href="<?php echo e(route('coupon.create')); ?>"><?php echo e(__('sentence.New Coupon')); ?></a>
                            <a class="collapse-item"
                                href="<?php echo e(route('coupon.all')); ?>"><?php echo e(__('sentence.All Coupons')); ?></a>
                        </div>
                    </div>
                </li>
                <!-- Divider -->
...
</html><?php /**PATH E:\xampp\htdocs\medicaladmin\resources\views/layouts/master.blade.php ENDPATH**/ ?>