                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4 col-sm-6">
                            <center><img
                                    src="<?php echo e(empty($patient->Patient->image) ? asset('img/patient-icon.png') : url('imgs/' . $patient->Patient->image)); ?>"
                            ...
                            <?php if(isset($patient->Patient->birthday)): ?>
                                <p><b><?php echo e(__('sentence.Age')); ?> :</b> <?php echo e($patient->Patient->birthday); ?>
                                    ...
                                    <table class="table">
                                        ...
                                        <?php $__empty_1 = true; $__currentLoopData = $appointments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $appointment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <tr>
                                                ...
                                                <td align="center"><?php echo e($appointment->time_start); ?> -
                                                    <?php echo e($appointment->time_end); ?> </td>
                                                <td class="text-center">
                                                    <?php if($appointment->visited == 0): ?>
                                                        <a href="#" class="btn btn-warning btn-icon-split btn-sm">
                                                            ...
                                                            <span
                                                                class="text"><?php echo e(__('sentence.Not Yet Visited')); ?></span>
                                                        </a>
                                        ...
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                            <tr>
                                                <td colspan="5" align="center">
                                                    <?php echo e(__('sentence.No appointment available')); ?></td>
                                            </tr>
                                        <?php endif; ?>
                                    </table>
                                </div>
                                                ...
                                                <td align="center">
                                                    <a href="<?php echo e(url('prescription/view/' . $prescription->id)); ?>"
                                                        class="btn btn-success btn-circle btn-sm"><i
                                                            class="fa fa-eye"></i></a>
                                                    <a href="<?php echo e(url('prescription/pdf/' . $prescription->id)); ?>"
                                        ...
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                            <tr>
                                                <td colspan="3" align="center">
                                                    <?php echo e(__('sentence.No prescription available')); ?></td>
                                            </tr>
                                        <?php endif; ?>
                                    </table>
                                </div>
                                    ...
                                    <table class="table">
                                        ...
                                        <?php $__empty_1 = true; $__currentLoopData = $invoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <tr>
                                                ...
                                                <td> <?php echo e($invoice->Items->sum('invoice_amount')); ?>
                                                ...
                                                <td>
                                                    <a href="<?php echo e(url('billing/view/' . $invoice->id)); ?>"
                                                        class="btn btn-success btn-circle btn-sm"><i
                                                            class="fa fa-eye"></i></a>
                                                    <a href="<?php echo e(url('billing/pdf/' . $invoice->id)); ?>"
                                                        class="btn btn-primary btn-circle btn-sm"><i
                                                            class="fas fa-print"></i></a>
                                        ...
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                            ...
                                            <td colspan="6" align="center"><?php echo e(__('sentence.No Invoices Available')); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\doctor1\resources\views/patient/view.blade.php ENDPATH**/ ?>