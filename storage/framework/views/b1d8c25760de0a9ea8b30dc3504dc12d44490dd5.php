<?php $__env->startSection('title'); ?>
    <?php echo e(__('sentence.Edit Nurse booking')); ?>
        ...
        <div class="col-md-8">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary"><?php echo e(__('sentence.Edit Nurse booking')); ?></h6>
                </div>
                <div class="card-body">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\doctor1\resources\views/nursebooking/edit.blade.php ENDPATH**/ ?>