      ...
      <div id="app">
         ...
         <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
               ...
               <!-- Nav Item - Pages Collapse Menu -->
               <li class="nav-item">
                  <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseNurseBooking" aria-expanded="true" aria-controls="collapseNurseBooking">
                  <i class="fas fa-fw fa-users"></i>
                  <span><?php echo e(__('sentence.Nurse Booking')); ?></span>
                  </a>
                  <div id="collapseNurseBooking" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                     <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="<?php echo e(route('nursebooking.create')); ?>"><?php echo e(__('sentence.New Nurse Booking')); ?></a>
                        <a class="collapse-item" href="<?php echo e(route('nursebooking.all')); ?>"><?php echo e(__('sentence.All Nurse Bookings')); ?></a>
                     </div>
                  </div>
               </li>
               <!-- Divider -->
...
<?php /**PATH E:\Xampp\htdocs\medicaladmin\resources\views/layouts/master.blade.php ENDPATH**/ ?>