                                    ...
                                    <table class="table">
                                        ...
                                        @forelse($appointments as $appointment)
                                            <tr>
                                                ...
                                                <td align="center">{{ $appointment->time_start }} -
                                                ...
                                                <td class="text-center">
                                                    @if ($appointment->visited == 0)
                                                        <a href="#" class="btn btn-warning btn-icon-split btn-sm">
                                                            ...
                                                            <span
                                                                class="text">{{ __('sentence.Not Yet Visited') }}</span>
                                                        </a>
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="5" align="center">
                                                    {{ __('sentence.No appointment available') }}</td>
                                            </tr>
                                        @endforelse
                                    </table>
                                </div>
                                                ...
                                                <td align="center">
                                                    <a href="{{ url('prescription/view/' . $prescription->id) }}"
                                                        class="btn btn-success btn-circle btn-sm"><i
                                                            class="fa fa-eye"></i></a>
                                                    <a href="{{ url('prescription/pdf/' . $prescription->id) }}"
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="3" align="center">
                                                    {{ __('sentence.No prescription available') }}</td>
                                            </tr>
                                        @endforelse
                                    </table>
                                </div>
                                    ...
                                    <table class="table">
                                        ...
                                        @forelse($invoices as $invoice)
                                            <tr>
                                                ...
                                                <td> {{ $invoice->Items->sum('invoice_amount') }}
                                                ...
                                                <td>
                                                    <a href="{{ url('billing/view/' . $invoice->id) }}"
                                                        class="btn btn-success btn-circle btn-sm"><i
                                                            class="fa fa-eye"></i></a>
                                                    <a href="{{ url('billing/pdf/' . $invoice->id) }}"
                                                        class="btn btn-primary btn-circle btn-sm"><i
                                                            class="fas fa-print"></i></a>
                                        ...
                                        @empty
                                            ...
                                            <td colspan="6" align="center">{{ __('sentence.No Invoices Available') }}
                                            </td>
                                        @endforelse
                                    </table>
                                </div>
