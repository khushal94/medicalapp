            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
               ...
               <li class="nav-item">
                  ...
                  <div id="collapseNurse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                     <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{ route('nurse.create') }}">{{ __('sentence.New Nurse') }}</a>
               ...
               <li class="nav-item">
                  ...
                  <div id="collapseNurseBooking" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                     <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{ route('nursebooking.create') }}">{{ __('sentence.New Nurse Booking') }}</a>
                        <a class="collapse-item" href="{{ route('nursebooking.all') }}">{{ __('sentence.All Nurse Bookings') }}</a>
                     </div>
                  </div>
               </li>
               <!-- Divider -->
